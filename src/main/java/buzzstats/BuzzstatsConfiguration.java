...
public class BuzzstatsConfiguration extends Configuration {
  ...
  @Valid @NotNull private int crawlerInterval = 10;

  @Valid @NotNull private int oldestCheckedStoryInterval = 10;

  @Valid @NotNull private Map<String, Map<String, String>> viewRendererConfiguration;
