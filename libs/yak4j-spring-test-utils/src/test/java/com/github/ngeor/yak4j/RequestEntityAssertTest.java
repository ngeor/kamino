...
class RequestEntityAssertTest {
    ...
    void hasUrl_fail() {
        RequestEntity<String> requestEntity =
                RequestEntity.post(URI.create("http://localhost/")).body("hello world");
        assertThatThrownBy(() -> Assertions.assertThat(requestEntity).hasUrl(URI
                .create("http://localhost:8080/"))).isInstanceOf(AssertionError.class).hasMessage(
                        "Expecting request entity url to be http://localhost:8080/ but was http://localhost/");
    }
    ...
    void hasUrl_asString_fail() {
        RequestEntity<String> requestEntity =
                RequestEntity.post(URI.create("http://localhost/")).body("hello world");
        assertThatThrownBy(() -> Assertions.assertThat(requestEntity)
                .hasUrl("http://localhost:8080/")).isInstanceOf(AssertionError.class).hasMessage(
                        "Expecting request entity url to be http://localhost:8080/ but was http://localhost/");
    }
    ...
    void hasBody_fail() {
        ...
        assertThatThrownBy(() -> Assertions.assertThat(requestEntity).hasBody("hello, world!"))
                .isInstanceOf(AssertionError.class).hasMessage(
                        "Expecting request entity body to be hello, world! but was hello world");
    }

    @Test
    void hasAcceptHeader_pass() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .accept(MediaType.APPLICATION_JSON).body("hello world");
    ...
    void hasAcceptHeader_fail() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .accept(MediaType.APPLICATION_JSON).body("hello world");
        assertThatThrownBy(() -> Assertions.assertThat(requestEntity).hasAcceptHeader(
                MediaType.APPLICATION_PDF)).isInstanceOf(AssertionError.class).hasMessage(
                        "Expecting request entity Accept header to be application/pdf but was [application/json]");
    }
    ...
    void hasAcceptHeader_fail_noHeader() {
        ...
        assertThatThrownBy(() -> Assertions.assertThat(requestEntity).hasAcceptHeader(
                MediaType.APPLICATION_PDF)).isInstanceOf(AssertionError.class).hasMessage(
                        "Expecting request entity Accept header to be application/pdf but was []");
    }

    @Test
    void hasAcceptHeader_fail_twoHeaderValues() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .accept(MediaType.APPLICATION_JSON, MediaType.TEXT_HTML).body("hello world");
        String message =
                "Expecting request entity Accept header to be application/json but was [application/json, text/html]";
        assertThatThrownBy(() -> Assertions.assertThat(requestEntity)
                .hasAcceptHeader(MediaType.APPLICATION_JSON)).isInstanceOf(AssertionError.class)
                        .hasMessage(message);
    }
    ...
    void hasJsonAcceptHeader_fail() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .accept(MediaType.APPLICATION_XML).body("hello world");
        assertThatThrownBy(() -> Assertions.assertThat(requestEntity).hasJsonAcceptHeader())
                .isInstanceOf(AssertionError.class).hasMessage(
                        "Expecting request entity Accept header to be application/json but was [application/xml]");
    }

    @Test
    void hasContentTypeHeader_pass() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .contentType(MediaType.APPLICATION_JSON).body("hello world");
    ...
    void hasContentTypeHeader_fail() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .contentType(MediaType.APPLICATION_JSON).body("hello world");
        assertThatThrownBy(() -> Assertions.assertThat(requestEntity).hasContentTypeHeader(
                MediaType.APPLICATION_PDF)).isInstanceOf(AssertionError.class).hasMessage(
    ...
    void hasJsonContentTypeHeader_fail() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .contentType(MediaType.APPLICATION_XML).body("hello world");
    ...
    void hasJsonAcceptAndContentTypeHeaders_fail_wrongAccept() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .accept(MediaType.APPLICATION_XML).contentType(MediaType.APPLICATION_JSON)
                .body("hello world");
        String message =
                "Expecting request entity Accept header to be application/json but was [application/xml]";
        assertThatThrownBy(
                () -> Assertions.assertThat(requestEntity).hasJsonAcceptAndContentTypeHeaders())
                        .isInstanceOf(AssertionError.class).hasMessage(message);
    }

    @Test
    void hasJsonAcceptAndContentTypeHeaders_fail_wrongContentType() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_XML)
                .body("hello world");
        String message =
                "Expecting request entity Content-Type header to be application/json but was application/xml";
        assertThatThrownBy(
    ...
    void hasAuthorizationHeader_pass() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .header("Authorization", "Basic 1234").body("hello world");
    ...
    void hasAuthorizationHeader_fail() {
        RequestEntity<String> requestEntity = RequestEntity.post(URI.create("http://localhost/"))
                .header("Authorization", "Basic 1234").body("hello world");
        assertThatThrownBy(() -> Assertions.assertThat(requestEntity).hasAuthorizationHeader(
                "Basic abcd")).isInstanceOf(AssertionError.class).hasMessage(
                        "Expecting request entity Authorization header to be Basic abcd but was [Basic 1234]");
    }
    ...
    void hasAuthorizationHeader_fail_noHeader() {
        ...
        assertThatThrownBy(() -> Assertions.assertThat(requestEntity).hasAuthorizationHeader(
                "Basic abcd")).isInstanceOf(AssertionError.class).hasMessage(
                        "Expecting request entity Authorization header to be Basic abcd but was null");
    }
}
