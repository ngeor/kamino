 ...
 * @since 0.12.0
 */
public class RequestEntityAssert<T>
        extends AbstractAssert<RequestEntityAssert<T>, RequestEntity<T>> {
    ...
    public RequestEntityAssert<T> hasMethod(HttpMethod httpMethod) {
        ...
        Assertions.assertThat(actualMethod)
                .withFailMessage("Expecting request entity method to be %s but was %s", httpMethod,
                        actualMethod)
                .isNotNull().isEqualTo(httpMethod);
        return this;
    }
    ...
    public RequestEntityAssert<T> hasUrl(String url) {
        ...
        Assertions.assertThat(actualUrl)
                .withFailMessage("Expecting request entity url to be %s but was %s", url, actualUrl)
                .isNotNull().isEqualTo(URI.create(url));
        return this;
    }
    ...
    public RequestEntityAssert<T> hasBody(T body) {
        ...
        Assertions.assertThat(actualBody)
                .withFailMessage("Expecting request entity body to be %s but was %s", body,
                        actualBody)
                .isNotNull().isEqualTo(body);
        return this;
    ...
    public RequestEntityAssert<T> hasAcceptHeader(MediaType mediaType) {
        ...
        Assertions.assertThat(actualAccept)
                .withFailMessage("Expecting request entity Accept header to be %s but was %s",
                        mediaType, actualAccept)
    ...
    public RequestEntityAssert<T> hasContentTypeHeader(MediaType mediaType) {
        ...
        Assertions.assertThat(actualContentType)
                .withFailMessage("Expecting request entity Content-Type header to be %s but was %s",
    ...
    public RequestEntityAssert<T> hasAuthorizationHeader(String value) {
        ...
        Assertions.assertThat(actualAuthorization)
                .withFailMessage(
                        "Expecting request entity Authorization header to be %s but was %s", value,
                        actualAuthorization)
